...
const Prizes = () => {
    ...
    return (
        <section id="rewards" className="section-padding bg-bg-base relative overflow-hidden">

            {/* Subtle prismatic ambient glow */}
            <div className="absolute top-[50%] left-[20%] w-[400px] h-[400px] rounded-full blur-[150px] opacity-20 pointer-events-none" style={{ background: 'radial-gradient(circle, #8a5cff, transparent)' }} />
            <div className="absolute top-[30%] right-[10%] w-[300px] h-[300px] rounded-full blur-[120px] opacity-15 pointer-events-none" style={{ background: 'radial-gradient(circle, #ff5c7a, transparent)' }} />
            ...
            <div className="max-w-[1200px] mx-auto px-6 relative z-10">
                ...
                >
                    <p className="font-mono text-[13px] font-bold uppercase tracking-[4px] mb-[32px]" style={{ color: '#8a5cff' }}>
                        The Rewards
                    </p>

                    <h2 className="font-display font-black text-[clamp(44px,7vw,72px)] text-accent-primary tracking-[-0.04em] leading-[1.05] mb-[24px]">
                ...
                >
                    ...
                    {prizes.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center gap-[12px] mb-[40px]">
                                    <div
                                        ...
                                        style={{ background: item.accent, boxShadow: `0 0 12px ${item.accentGlow}` }}
                                    />
                                    <span className="font-mono text-[12px] font-bold tracking-[3px] uppercase" style={{ color: item.accent }}>
                                        {item.ps}
                                    </span>
                                </div>
                            ...
                            <div className="relative z-10 mt-[48px] border-t pt-[24px]" style={{ borderColor: item.accentBorder }}>
                                <span className="font-mono text-[13px] tracking-[2px]" style={{ color: item.accent, opacity: 0.5 }}>
                                    PRIZE: TBA
                                </span>
                            </div>
